...
from cs336_basics.bpe import run_nboy_bpe, Tokenizer
...
def run_transformer_block(
    ...
    rope = RotaryPositionalEmbedding(
        theta, d_model // num_heads, max_seq_len, device=get_device(), dtype=torch.float32
    )
    transformer_block = PreNormTransformer(d_model, num_heads, d_ff, rope, device=get_device())
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return run_nboy_bpe(input_path, vocab_size, special_tokens, **kwargs)
